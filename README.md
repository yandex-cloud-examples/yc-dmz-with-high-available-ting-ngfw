...
1. В левом меню в секции `Межсетевой экран` выберите `Псевдонимы`. С помощью кнопки `+` добавьте псевдонимы в соответствии с таблицей ниже. После добавления всех псевдонимов на `Межсетевой экран: Псевдонимы` нажмите `Применить`.
